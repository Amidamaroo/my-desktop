...
BASE_PACKAGES = [
    "tumbler", "ffmpegthumbnailer", "lsd", "kitty","ibat", "brightnessctl", "calc",
    ...
    "pulseaudio-alsa", "python-pyalsa", "yazi","reflector", "rofi", "rofi-calc", "calcurse",
    ...
    "ttf-iosevka-nerd", "otf-codenewroman-nerd", "firefox", "vim", "lolcat","cowfortune", "ttf-anonymouspro-nerd"
]
